...
export default function Footer(){
  return (
    <div className="mt-4 bg-dark-200 rounded-md text-white px-8 py-4">
      ...
      <p className="text-sm font-light text-center">Copyright © 2023 Shrajan Jain. All Right Reserved</p>
      <p className="text-sm font-light text-center">jainshrajan482@gmail.com</p>
